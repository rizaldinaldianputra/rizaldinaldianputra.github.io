...
$curl = curl_init();
//mengmanggil url
curl_setopt($curl, CURLOPT_URL, 'https://www.googleapis.com/youtube/v3/channels?part=statistics,snippet&id=UCwBBAktFvQeqHXfxIA8i3SQ&key=AIzaSyDxvZ_NiV1NWe4e0uwukrpuUZt0KaQbmO4');
// kembalianya text
...
<head>
	<title>RIZALDI NALDIAN PUTRA</title>
	<meta charset="utf-8">
...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
	...
	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar ftco-navbar-light site-navbar-target" id="ftco-navbar">
		<div class="container">
			<a class="navbar-brand" href="index.html"><span>R</span>izaldi</a>
			...
			<div class="row no-gutters slider-text js-fullheight justify-content-center align-items-center">
				<div class="col-lg-8 col-md-6 ftco-animate d-flex align-items-center">
					<div class="text text-center">
						...
						<h1>Rizaldi Naldian Putra</h1>
						<hr>
						<h2>I'm a
							<span class="txt-rotate" data-period="2000" data-rotate='[ "Web Designer.", "Full Stack Developer.", "Analyst System.", "Content Creator." ]'></span>
						</h2>
					</div>
				</div>
			</div>
					...
					<div class="row justify-content-start pb-3">
						<div class="col-md-12 heading-section ftco-animate">
							...
							<ul class="about-info mt-4 px-md-0 px-2">
								<li class="d-flex"><span>Name:</span> <span>Rizaldi Naldian Putra</span></li>
								<li class="d-flex"><span>Date of birth:</span> <span>March 15, 1996</span></li>
								<li class="d-flex"><span>Address:</span> <span>Kp. Kebon Kopi RT:04 RW:09 Kel: Kebon
										Kelapa
										Kec: Kota Bogor Tengah
									</span></li>
								<li class="d-flex"><span>Zip code:</span> <span>16125</span></li>
								<li class="d-flex"><span>Email:</span> <span>rizaldi.naldian@gmail.com</span></li>
								<li class="d-flex"><span>Phone: </span> <span>+62-8138-0244-442</span></li>
							</ul>
						</div>
					</div>
					...
					<div id="page-1" class="page one">
						...
						<div class="resume-wrap d-flex ftco-animate">
							...
							<div class="text pl-3">
								...
								<h2>SMK TARUNA TERPADU 2</h2>
								<span class="position">Akuntansi</span>
							</div>
						</div>
						<div class="resume-wrap d-flex ftco-animate">
							<div class="icon d-flex align-items-center justify-content-center">
							...
							<div class="text pl-3">
								...
								<h2>EL - RAHMA EDUCATION CENTER</h2>
								<span class="position">Informatika Teknik Komputer</span>
								<p></p>
							</div>
						</div>
						<div class="resume-wrap d-flex ftco-animate">
							...
							<div class="text pl-3">
								...
								<span class="position">Sistem Informasi</span>
					...
					<div id="page-2" class="page two">
						...
						<div class="resume-wrap d-flex ftco-animate">
							...
							<div class="text pl-3">
								<span class="date">2015-2016</span>
								<h2>PT.Kahatex</h2>
								<span class="position">Quality Controling</span>
								<p> Memantau perkembangan semua produk yang diproduksi oleh perusahaan.
						...
						<div class="resume-wrap d-flex ftco-animate">
							...
							<div class="text pl-3">
								...
								<h2>PT.JUNGLELAND ASIA</h2>
								<span class="position">STAFF OPERASIONAL</span>
								<p>Melakukan Kegiatan Operasional yang berada pada wahanan dan memastikan kepuasan
									pelanggan terjaga dan memberikan service excelent terhadap customer yang berkunjung
									lalu tidak lupa selalu berpenampilan menarik </p>
							</div>
						</div>
						...
						<div id="page-4" class="page one">
							...
							<div class="resume-wrap d-flex ftco-animate">
								...
								<div class="text pl-3">
									<span class="date">2015-2016</span>
									<h2>Best Employee</h2>
									<span class="position">PT.Kahaptex</span>
									<p>Menjadi karyawan terbaik di akhir tahun</p>
								</div>
							</div>
	</section>
			...
			<div class="row">
				...
				<div class="col-md-4 text-center d-flex ftco-animate">
					<a href="#" class="services-1 shadow">
						...
						<div class="desc">
							<h3 class="mb-5">Conten Creator</h3>
							<p>Video Gaming</p>
						</div>
					</a>
				</div>
		...
		<div class="container-fluid px-md-0">
			<div class="row no-gutters justify-content-center pb-5">
				<div class="col-md-12 heading-section text-center ftco-animate">
					...
					<p>Projects Website & Mobile </p>
				</div>
			</div>
			<div class="row no-gutters">
				<div class="col-md-4">
					<div class="project img ftco-animate d-flex justify-content-center align-items-center" style="background-image: url(images/work-1.png);">
						<div class="overlay"></div>
						<div class="text text-center p-4">
							<h3><a href="#">Sistem Informasi Geografis Daerah Rawan Kriminalitas</a></h3>
							<span>Web GIS</span>
						</div>
					</div>
				</div>
				...
				<div class="col-md-6 col-lg-3 d-flex ftco-animate">
					<div class="align-self-stretch box text-center p-4 shadow">
						...
						<div>
							...
							<p>Kp. Kebon Kopi RT:04 RW:09 Kel: Kebon Kelapa
								Kec: Kota Bogor Tengah</p>
						</div>
					</div>
				</div>
				<div class="col-md-6 col-lg-3 d-flex ftco-animate">
					<div class="align-self-stretch box text-center p-4 shadow">
						...
						<div>
							...
							<p><a href="tel://1234567920">+62-81380-244-442</a></p>
						</div>
					</div>
				</div>
				<div class="col-md-6 col-lg-3 d-flex ftco-animate">
					<div class="align-self-stretch box text-center p-4 shadow">
						...
						<div>
							...
							<p><a href="mailto:info@yoursite.com">Rizaldi.naldian@gmail.com</a></p>
						</div>
					</div>
				</div>
				<div class="col-md-6 col-lg-3 d-flex ftco-animate">
					<div class="align-self-stretch box text-center p-4 shadow">
						...
						<div>
							...
							<p><a href="#">Rizaldinaldianputra.com</a></p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row mb-5">
				<div class="col-md">
					<div class="ftco-footer-widget mb-4">
						...
						<p>Perkanalkan nama Saya Rizaldi Naldian Putra.
							biasa di panggil rizal atapun aldi. hobi saya bermain futsal dan bermain game online dan
							kepribadian saya adalah orang yang ramah tamah, gampang bergaul . lalu sangat gemar sekali
							mempelajari hal baru khusunya dengan dunia teknologi. dan saya tidak mempunyai riwayat
							penyakit apapun . dan saya tidak juga perokok.


						</p>
						<ul class="ftco-footer-social list-unstyled float-md-left float-lft mt-5">
							<li class="ftco-animate"><a href="https://twitter.com/naldianputra"><span class="icon-twitter"></span></a></li>
							<li class="ftco-animate"><a href="https://www.facebook.com/adhi76"><span class="icon-facebook"></span></a></li>
							<li class="ftco-animate"><a href="https://www.instagram.com/rizaldinaldianputra/"><span class="icon-instagram"></span></a></li>
							<li class="ftco-animate"><a href="https://www.youtube.com/channel/UCwBBAktFvQeqHXfxIA8i3SQ"><span class="icon-youtube"></span></a></li>
						</ul>
					</div>
				</div>
				<div class="col-md">
				...
				<div class="col-md">
					<div class="ftco-footer-widget mb-4">
						...
						<div class="block-23 mb-3">
							<ul>
								<li><span class="icon icon-map-marker"></span><span class="text">No:22 Jl. Kb. Kopi
										No.03/09, RT.06/RW.09, Kb. Klp., Kecamatan Bogor Tengah, Kota Bogor, Jawa Barat
										16125</span></li>
								<li><a href="#"><span class="icon icon-phone"></span><span class="text">+62-8138-0244-442</span></a></li>
								<li><a href="#"><span class="icon icon-envelope"></span><span class="text">rizaldi.naldian@gmail.com</span></a></li>
							</ul>
						</div>
					</div>
				</div>
